...
public class Flow {
    ...
    public void print() {
        ...
        for (int i = 0; i < points.length; i++) {
            System.out.println("Point " + i + " - " + orders[i].getId() + " : " + points[i][0].toString() + " - " + points[i][1].toString());
        }
    ...
    public String toString() {
        ...
        str.append("Duration = ").append(LocalTime.ofSecondOfDay(Math.abs(Duration.between(this.start, this.end).get(ChronoUnit.SECONDS))));
        return str.toString();
    }
}
